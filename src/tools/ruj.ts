  ...
  server.tool(
    ...
    ].join(" "),
    {
      ...
      journal_title: z
        ...
        .optional()
        .describe(
          "Journal title filter (default op: contains). " + "Maps to DSpace field journalTitle.",
        ),
      subtype: z.string().optional().describe("Publication subtype filter (default op: equals)."),
      entity_type: z
        .string()
        .optional()
        .describe(
          "DSpace entity type filter (default op: equals). " + "Maps to DSpace field entityType.",
        ),
      pbn_discipline: z
        .string()
        .optional()
      ...
      return withToolExecutionSpan(
        ...
        async (span) => {
          ...
          try {
            ...
            if (affiliation_em)
              addFilter(searchParams, "affiliationEm", affiliation_em, "contains");
